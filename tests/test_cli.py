...
def test_cli():
    # Test 1
    os.system("python ismags/cli/cli.py -f 'tests/test_data/' -l \"A d t t\" -n 'graph1_Ad.txt' -m AA0A00 -o 'graph1.out'")
    os.remove("graph1.out")
    
    # Test 2
    os.system("python ismags/cli/cli.py -f 'tests/test_data/' -l \"A d t t,B u t t\" -n 'graph2_Ad.txt,graph2_Bu.txt' -m AB0B00 -o 'graph2.out'")
    os.remove("graph2.out")
    
    # Test 3
    os.system("python ismags/cli/cli.py -f 'tests/test_data/' -l \"A d t t,B d t t,C d t t,D d t t,E d t t,F d t t\" \
    ...
    # Test 4
    os.system("python ismags/cli/cli.py -f 'tests/test_data/' -l \"A d t t,B d t t,C d t t,D u t t\" \
    -n 'graph4_Ad.txt,graph4_Bd.txt,graph4_Cd.txt,graph4_Du.txt' \
    -m ABDC00 -o 'graph4.out'")
    os.remove("graph4.out")
    
    # Test 5
    os.system("python ismags/cli/cli.py -f 'tests/test_data/' -l \"A d t t,B d t t,C d t t\" \
